...
C
C----------------------------------------------------------------------
      INTEGER I,IBETA,IEXP,II,III,IOUT,IRND,IT,IZE,J,JT,J1,J2,K,KK,K1,
     1    K2,K3,LAST,M,MACHEP,MAXEXP,MB,MBORG,MINEXP,MVR,N,NCALC,NDUM,
     2    NDX,NDX2,NEGEP,NGRD,NK,NO1,NUM
CS    REAL  
CD    DOUBLE PRECISION  
     1    A,AIT,AK,AKK,ALBETA,ALPHA,ALPHSQ,A1,AR1,AR2,B,BETA,C,CONV,D,
     2    DEL,DELTA,DERIV,E,EPS,EPSNEG,F,G,HALF,HUND,ONE,REN,R6,R7,SIX,
     3    SIXTEN,SUM,TEN,TWO,T1,T2,U,U2,W,X,XBAD,XL,XLAM,XLARGE,XMAX,
     4    XMIN,XN,X1,X99,Y,YSQ,Z,ZERO,ZZ
