...
/*int main(void){
double x_gsl_sf_airy_Ai ;
klee_make_symbolic(&x_gsl_sf_airy_Ai,sizeof x_gsl_sf_airy_Ai,"x_gsl_sf_airy_Ai");
gsl_mode_t mode_gsl_sf_airy_Ai ;
//klee_make_symbolic(&mode_gsl_sf_airy_Ai,sizeof mode_gsl_sf_airy_Ai,"mode_gsl_sf_airy_Ai");
gsl_sf_airy_Ai(x_gsl_sf_airy_Ai,mode_gsl_sf_airy_Ai);
return 0;
}*/
