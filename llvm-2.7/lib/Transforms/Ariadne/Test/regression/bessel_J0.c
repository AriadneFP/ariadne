...
#include <Ariadne.h> //for testing
#include <klee/klee.h> //for testing
#include <config.h>
...
int main(void){
  double x_gsl_sf_bessel_J0 ;
  klee_make_symbolic(&x_gsl_sf_bessel_J0,sizeof x_gsl_sf_bessel_J0,"x_gsl_sf_bessel_J0");
  gsl_sf_bessel_J0(x_gsl_sf_bessel_J0);
  return 0;
}