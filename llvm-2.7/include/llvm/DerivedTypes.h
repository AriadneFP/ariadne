...
public:
  ...
  //Thanh add this function to modify the return type of function
  void setReturnType(const Type *ty) const { ContainedTys[0].setType(ty); }
  ...
  void setParamType(unsigned i, const Type *ty) const { ContainedTys[i+1] = ty; }
