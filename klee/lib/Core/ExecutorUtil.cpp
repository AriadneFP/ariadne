...
namespace klee {
  ...
  ref<ConstantExpr> Executor::evalConstantExpr(llvm::ConstantExpr *ce) {
    ...
    case Instruction::FCmp:
    	switch(ce->getPredicate()) {
    	      default: assert(0 && "unhandled ICmp predicate");
    	      case FCmpInst::FCMP_UEQ:  return op1->Eq(op2);
    	      case FCmpInst::FCMP_UNE:  return op1->Ne(op2);
    	      case FCmpInst::FCMP_UGT: return op1->Ugt(op2);
    	      case FCmpInst::FCMP_UGE: return op1->Uge(op2);
    	      case FCmpInst::FCMP_ULT: return op1->Ult(op2);
    	      case FCmpInst::FCMP_ULE: return op1->Ule(op2);
    	      case FCmpInst::FCMP_OGT: return op1->Sgt(op2);
    	      case FCmpInst::FCMP_OGE: return op1->Sge(op2);
    	      case FCmpInst::FCMP_OLT: return op1->Slt(op2);
    	      case FCmpInst::FCMP_OLE: return op1->Sle(op2);
       }
