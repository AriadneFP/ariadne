...
namespace klee {
  ...
  class StatsTracker {
    ...
    std::ostream *statsFile, *istatsFile, *ariadneStatsFile;
    double startWallTime;
    
    unsigned numBranches;
    unsigned fullBranches, partialBranches;

    unsigned nonlinearSolutions;
    unsigned linearSolutions;
  ...
  private:
    ...
    /* Methods to print Ariadne stat info */
    void writeAriadneStats();
  ...
  public:
    ...
    void incNonlinearSolutions() { nonlinearSolutions++;}

    void incLinearSolutions() {linearSolutions++;}
