...
StatsTracker::StatsTracker(Executor &_executor, std::string _objectFilename,
  ...
  ariadneStatsFile = executor.interpreterHandler->openOutputFile("ariadneRun.stats");
  if (OutputStats) {
...
void StatsTracker::writeStatsLine() {
  *statsFile << "(" << stats::instructions
             ...
             << "," << stats::singleTime / 1000000.
             << "," << stats::multipleTime / 1000000.
             << "," << stats::z3Time / 1000000.
             << "," << stats::polyTime / 1000000.
...
void StatsTracker::writeAriadneStats() {
	*ariadneStatsFile << "Ariadne stat information:\n"
			   << "Linear Solutions: " << linearSolutions << "\n"
	           << "Nonlinear Solutions: " << nonlinearSolutions << "\n";
	ariadneStatsFile->flush();
}
