...
namespace stats {
  ...
  /*** Ariadne Additions ***/
  extern Statistic singleTime;
  extern Statistic multipleTime;
  extern Statistic z3Time; // Time spent in Z3 Solver
  extern Statistic polyTime; // Time spent in Poly Solver
